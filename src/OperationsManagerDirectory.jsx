...
const OperationsManagerDirectory = () => {
    ...
    <div className="min-h-screen bg-[#0D1B2A] p-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-white text-2xl sm:text-3xl font-bold">Operations Manager Directory</h1>
          <button
            onClick={handleBack}
...
export default OperationsManagerDirectory; 