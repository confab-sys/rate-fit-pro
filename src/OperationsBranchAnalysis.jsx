...
const OperationsBranchAnalysis = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#0D1B2A]">
      <div className="p-6">
        <div className="mb-8">
          <h1 className="text-white text-xl sm:text-2xl font-bold text-center">Operations Branch Analysis</h1>
        </div>
              ...
              <div key={branch.id} className="bg-[#2C3E50] rounded-lg p-4">
                ...
                <div className="h-[250px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      <Pie
                        data={Object.entries(branch.departments).map(([name, value]) => ({ name, value }))}
                        cx="50%"
                        cy="50%"
                        innerRadius={40}
                        outerRadius={80}
                ...
                <div className="mt-4 space-y-2">
                  {Object.entries(branch.departments).map(([dept, count], index) => (
                    <div key={dept} className="flex justify-between items-center">
                      ...
                      <span className="text-white text-sm font-medium">{count} staff</span>
                    </div>
                  ))}
                </div>
              </div>
...
export default OperationsBranchAnalysis; 