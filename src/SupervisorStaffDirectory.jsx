...
const SupervisorStaffDirectory = () => {
  ...
  const handleStaffClick = (staff) => {
    if (deleteMode) {
      ...
      navigate(`/view-staff-report/${staff.id}`, { state: { fromSupervisorMenu: true } });
    }
  };
  ...
  const handleDeleteConfirm = () => {
    if (staffToDelete) {
      navigate(`/confirm-delete/${staffToDelete.id}`, { state: { fromSupervisorMenu: true } });
    }
  };
...
export default SupervisorStaffDirectory; 