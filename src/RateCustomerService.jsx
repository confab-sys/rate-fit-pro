...
// Import score icons
const fiveCustomerScoreUrl = new URL('./assets/5-customer score.svg', import.meta.url).href;
const fourCustomerScoreUrl = new URL('./assets/4-customer score.svg', import.meta.url).href;
const threeCustomerScoreUrl = new URL('./assets/3-customer score.svg', import.meta.url).href;
const twoCustomerScoreUrl = new URL('./assets/2-customer score.svg', import.meta.url).href;
const oneCustomerScoreUrl = new URL('./assets/1-customer score.svg', import.meta.url).href;
...
const RateCustomerService = () => {
  ...
  const handleScoreClick = (score) => {
    ...
    storeRating('customer_service', scoreConfig[score].points, scoreConfig[score].percentage);
  };
  ...
  return (
    <div className="min-h-screen w-full bg-[#0D1B2A] p-6">
      <div className="flex flex-col items-center pt-8">
        <h1 className="text-white text-3xl font-bold mb-8">Rate Customer Service</h1>
        
        {staff && (
          <StaffDetailsWithScore staff={staff} weeklyRatings={weeklyRatings} />
        )}

        {/* Add CUSTOMER SERVICE text below the rectangle */}
        <div className="flex justify-center w-full mb-4">
          <span className="text-white text-lg sm:text-xl font-bold">🫱🏼‍🫲🏽 CUSTOMER SERVICE</span>
        </div>
        ...
        <div className="w-full max-w-lg sm:max-w-3xl mx-auto space-y-4">
          ...
          >
            <img src={fiveCustomerScoreUrl} alt="5 Customer Score" className="w-full h-auto" />
          </div>
          <div 
            className={`w-full cursor-pointer transition-all duration-200 ${
              selectedScore === 4 
          ...
          >
            <img src={fourCustomerScoreUrl} alt="4 Customer Score" className="w-full h-auto" />
          </div>
          <div 
            className={`w-full cursor-pointer transition-all duration-200 ${
              selectedScore === 3 
          ...
          >
            <img src={threeCustomerScoreUrl} alt="3 Customer Score" className="w-full h-auto" />
          </div>
          <div 
            className={`w-full cursor-pointer transition-all duration-200 ${
              selectedScore === 2 
          ...
          >
            <img src={twoCustomerScoreUrl} alt="2 Customer Score" className="w-full h-auto" />
          </div>
          <div 
            className={`w-full cursor-pointer transition-all duration-200 ${
              selectedScore === 1 
          ...
          >
            <img src={oneCustomerScoreUrl} alt="1 Customer Score" className="w-full h-auto" />
          </div>
        </div>
        ...
        <div className="flex justify-center w-full max-w-lg sm:max-w-3xl mx-auto mt-8 text-white text-center text-sm sm:text-base">
          The organization relies on its customers. Poor service drains resources and damages its reputation.
        </div>
...
export default RateCustomerService; 