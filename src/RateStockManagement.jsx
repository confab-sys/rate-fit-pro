...
// Import score icons
const fiveStockScoreUrl = new URL('./assets/5-stock score.svg', import.meta.url).href;
const fourStockScoreUrl = new URL('./assets/4-stock score.svg', import.meta.url).href;
const threeStockScoreUrl = new URL('./assets/3-stock score.svg', import.meta.url).href;
const twoStockScoreUrl = new URL('./assets/2-stock score.svg', import.meta.url).href;
const oneStockScoreUrl = new URL('./assets/1-stock score.svg', import.meta.url).href;
...
const RateStockManagement = () => {
  ...
  const handleScoreClick = (score) => {
    ...
    storeRating('stock_management', scoreConfig[score].points, scoreConfig[score].percentage);
  };
  ...
  return (
    <div className="min-h-screen w-full bg-[#0D1B2A] p-6">
      <div className="flex flex-col items-center pt-8">
        <h1 className="text-white text-3xl font-bold mb-8">Rate Stock Management</h1>
        
        {staff && (
          <StaffDetailsWithScore staff={staff} weeklyRatings={weeklyRatings} />
        )}

        {/* Add STOCK MANAGEMENT text below the rectangle */}
        <div className="flex justify-center w-full mb-4">
          <span className="text-white text-lg sm:text-xl font-bold">📊 STOCK MANAGEMENT</span>
        </div>
        ...
        <div className="w-full max-w-lg sm:max-w-3xl mx-auto space-y-4">
          ...
          >
            <img src={fiveStockScoreUrl} alt="5 Stock Score" className="w-full h-auto" />
          </div>
          <div 
            className={`w-full cursor-pointer transition-all duration-200 ${
              selectedScore === 4 
          ...
          >
            <img src={fourStockScoreUrl} alt="4 Stock Score" className="w-full h-auto" />
          </div>
          <div 
            className={`w-full cursor-pointer transition-all duration-200 ${
              selectedScore === 3 
          ...
          >
            <img src={threeStockScoreUrl} alt="3 Stock Score" className="w-full h-auto" />
          </div>
          <div 
            className={`w-full cursor-pointer transition-all duration-200 ${
              selectedScore === 2 
          ...
          >
            <img src={twoStockScoreUrl} alt="2 Stock Score" className="w-full h-auto" />
          </div>
          <div 
            className={`w-full cursor-pointer transition-all duration-200 ${
              selectedScore === 1 
          ...
          >
            <img src={oneStockScoreUrl} alt="1 Stock Score" className="w-full h-auto" />
          </div>
        </div>
        ...
        <div className="flex justify-center w-full max-w-lg sm:max-w-3xl mx-auto mt-8 text-white text-center text-sm sm:text-base">
          Stock is a core resource; mismanaging it undermines the entire organization.
        </div>
...
export default RateStockManagement; 