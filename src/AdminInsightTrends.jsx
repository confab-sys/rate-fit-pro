    ...
    <div className="min-h-screen w-full bg-[#0D1B2A]">
      <div className="p-3 sm:p-6">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-white text-xl sm:text-2xl font-bold text-center flex-1">Admin Insight Trends</h1>
...
export default AdminInsightTrends; 