...
const fiveTimeScoreUrl = new URL('./assets/5-time score.svg', import.meta.url).href;
const fourTimeScoreUrl = new URL('./assets/4-time score.svg', import.meta.url).href;
const threeTimeScoreUrl = new URL('./assets/3-time score.svg', import.meta.url).href;
const twoTimeScoreUrl = new URL('./assets/2-time score.svg', import.meta.url).href;
const oneTimeScoreUrl = new URL('./assets/1-time score.svg', import.meta.url).href;
...
const RateTime = () => {
  ...
  const handleScoreClick = (score) => {
    ...
    storeRating('time', scoreConfig[score].points, scoreConfig[score].percentage);
  };

  const handleBackwardClick = () => {
    navigate(`/rating-staff1/${staffId}`);
  };
  ...
  return (
    <div className="min-h-screen w-full bg-[#0D1B2A] p-6">
      <div className="flex flex-col items-center pt-8">
        <h1 className="text-white text-3xl font-bold mb-8">Rate Time Management</h1>
        
        {staff && (
          <StaffDetailsWithScore staff={staff} weeklyRatings={weeklyRatings} />
        )}

        {/* Add TIME MANAGEMENT text below the rectangle */}
        <div className="flex justify-center w-full mb-4">
          <span className="text-white text-lg sm:text-xl font-bold">⏰ TIME MANAGEMENT</span>
        </div>
        ...
        <div className="w-full max-w-lg sm:max-w-3xl mx-auto space-y-4">
          ...
          >
            <img src={fiveTimeScoreUrl} alt="5 Time Score" className="w-full h-auto" />
          </div>
          <div 
            className={`w-full cursor-pointer transition-all duration-200 ${
              selectedScore === 4 
          ...
          >
            <img src={fourTimeScoreUrl} alt="4 Time Score" className="w-full h-auto" />
          </div>
          <div 
            className={`w-full cursor-pointer transition-all duration-200 ${
              selectedScore === 3 
          ...
          >
            <img src={threeTimeScoreUrl} alt="3 Time Score" className="w-full h-auto" />
          </div>
          <div 
            className={`w-full cursor-pointer transition-all duration-200 ${
              selectedScore === 2 
          ...
          >
            <img src={twoTimeScoreUrl} alt="2 Time Score" className="w-full h-auto" />
          </div>
          <div 
            className={`w-full cursor-pointer transition-all duration-200 ${
              selectedScore === 1 
          ...
          >
            <img src={oneTimeScoreUrl} alt="1 Time Score" className="w-full h-auto" />
          </div>
        </div>
        ...
        <div className="flex justify-center w-full max-w-lg sm:max-w-3xl mx-auto mt-8 text-white text-center text-sm sm:text-base">
          Time management is the key to productivity; it's not about having time, it's about making time.
        </div>
