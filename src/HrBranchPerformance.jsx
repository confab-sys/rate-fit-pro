                ...
                >
                  <div className="flex flex-col">
                    ...
                    >
                      ...
                      <svg 
                        className={`w-6 h-6 text-gray-400 transform transition-transform duration-200 ${expandedBranches[branch.id] ? 'rotate-180' : ''}`}
                        fill="none" 
                        stroke="currentColor" 
                        viewBox="0 0 24 24"
                      >
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-3 max-w-7xl mx-auto px-2 sm:px-4">
          {filteredStaff.map((staff) => (
            <div
              ...
              onClick={() => navigate(`/hr-weekly-analysis/${staff.id}`, { state: { fromHrDashboard: true } })}
            >
